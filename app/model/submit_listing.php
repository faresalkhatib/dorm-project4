...
<body>
    <div class="container">
        <div class="dorm-header">
            ...
            <p class="location"><i class="fas fa-map-marker-alt"></i> <?= htmlspecialchars($dorm['location'] ?? 'Amman, Jordan') ?></p>
            <div class="price-tag">$<?= htmlspecialchars($dorm['price']) ?> / month</div>
        </div>
        
        <div class="gallery">
            <?php
            $images = array_filter(explode(',', $dorm['image']), function($img) {
        ...
        <div class="details-grid">
            ...
            <div class="owner-card">
                ...
                <div class="owner-info">
                    ...
                    <p><i class="fas fa-phone"></i> <?= htmlspecialchars($owner['phone_number'] ?? 'Not provided') ?></p>
                </div>
                    ...
                    <form id="bookingForm">
                        ...
                        <?php if (!empty($std_name) && !empty($std_number)): ?>
                            ...
                            <button type="submit" class="btn" id="submitBtn">
                                ...
                                <span id="spinner" class="spinner" style="display: none;"><i class="fas fa-spinner"></i></span>
                            </button>
                        <?php else: ?>
                ...
                <?php else: ?>
                <div class="booking-form">
                    <p>Please <a href="/login.php" style="color: var(--primary); font-weight: 600;">login</a> to book this dorm.</p>
                </div>
                <?php endif; ?>
            </div>
        </div>
